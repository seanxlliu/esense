...
export function useSession() {
  ...
  async function create<T extends Prisma.SessionCreateArgs>(
    args: Prisma.SelectSubset<T, Prisma.SessionCreateArgs>
  ) {
    try {
      return await request.post<
        Prisma.SelectSubset<T, Prisma.SessionCreateArgs>,
        Prisma.CheckSelect<T, Session, Prisma.SessionGetPayload<T>>
      >(`${endpoint}/session/create`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  function findFirst<T extends Prisma.SessionFindFirstArgs>(
  ...
  async function update<T extends Prisma.SessionUpdateArgs>(
    ...
    try {
      ...
      >(`${endpoint}/session/update`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function updateMany<T extends Prisma.SessionUpdateManyArgs>(
    args: Prisma.SelectSubset<T, Prisma.SessionUpdateManyArgs>
  ) {
    return await request.put<
      Prisma.SelectSubset<T, Prisma.SessionUpdateManyArgs>,
      Prisma.BatchPayload
    >(`${endpoint}/session/updateMany`, args, mutate);
  }

  async function upsert<T extends Prisma.SessionUpsertArgs>(
    ...
    try {
      return await request.post<
        ...
        Prisma.SessionGetPayload<T>
      >(`${endpoint}/session/upsert`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function del<T extends Prisma.SessionDeleteArgs>(
    args: Prisma.SelectSubset<T, Prisma.SessionDeleteArgs>
  ) {
    try {
      return await request.del<Prisma.SessionGetPayload<T>>(
  ...
  async function deleteMany<T extends Prisma.SessionDeleteManyArgs>(
  ...
  function aggregate<T extends Prisma.SessionAggregateArgs>(
    args: Prisma.Subset<T, Prisma.SessionAggregateArgs>,
    options?: RequestOptions<Prisma.GetSessionAggregateType<T>>
  ) {
    return request.get<Prisma.GetSessionAggregateType<T>>(
      `${endpoint}/session/aggregate`,
      args,
      options
    );
  ...
  >(
    args: Prisma.SubsetIntersection<T, Prisma.SessionGroupByArgs, OrderByArg> &
      InputErrors,
  ...
  function count<T extends Prisma.SessionCountArgs>(
