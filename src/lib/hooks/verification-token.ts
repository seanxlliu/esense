...
export function useVerificationToken() {
  ...
  async function create<T extends Prisma.VerificationTokenCreateArgs>(
    ...
    try {
      return await request.post<
        ...
        >
      >(`${endpoint}/verificationToken/create`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  function findMany<T extends Prisma.VerificationTokenFindManyArgs>(
  ...
  function findUnique<T extends Prisma.VerificationTokenFindUniqueArgs>(
  ...
  function findFirst<T extends Prisma.VerificationTokenFindFirstArgs>(
  ...
  async function update<T extends Prisma.VerificationTokenUpdateArgs>(
    ...
    try {
      return await request.put<
        ...
        Prisma.VerificationTokenGetPayload<T>
      >(`${endpoint}/verificationToken/update`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function updateMany<T extends Prisma.VerificationTokenUpdateManyArgs>(
    ...
    return await request.put<
      ...
      Prisma.BatchPayload
    >(`${endpoint}/verificationToken/updateMany`, args, mutate);
  }

  async function upsert<T extends Prisma.VerificationTokenUpsertArgs>(
    ...
    try {
      return await request.post<
        ...
        Prisma.VerificationTokenGetPayload<T>
      >(`${endpoint}/verificationToken/upsert`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function del<T extends Prisma.VerificationTokenDeleteArgs>(
  ...
  async function deleteMany<T extends Prisma.VerificationTokenDeleteManyArgs>(
  ...
  function aggregate<T extends Prisma.VerificationTokenAggregateArgs>(
  ...
  >(
    ...
    options?: RequestOptions<
      {} extends InputErrors
        ? Prisma.GetVerificationTokenGroupByPayload<T>
        : InputErrors
    >
  ) {
    return request.get<
  ...
  function count<T extends Prisma.VerificationTokenCountArgs>(
      ...
      T extends { select: any }
        ? T['select'] extends true
          ...
          : Prisma.GetScalarType<
              T['select'],
              Prisma.VerificationTokenCountAggregateOutputType
            >
        : number
    >
  ) {
