...
export function useAccount() {
  ...
  async function create<T extends Prisma.AccountCreateArgs>(
    ...
    try {
      ...
      >(`${endpoint}/account/create`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  function findUnique<T extends Prisma.AccountFindUniqueArgs>(
    args: Prisma.SelectSubset<T, Prisma.AccountFindUniqueArgs>,
    options?: RequestOptions<Prisma.AccountGetPayload<T>>
  ) {
    return request.get<Prisma.AccountGetPayload<T>>(
      `${endpoint}/account/findUnique`,
      args,
      options
    );
  }

  function findFirst<T extends Prisma.AccountFindFirstArgs>(
    args: Prisma.SelectSubset<T, Prisma.AccountFindFirstArgs>,
    options?: RequestOptions<Prisma.AccountGetPayload<T>>
  ) {
    return request.get<Prisma.AccountGetPayload<T>>(
      `${endpoint}/account/findFirst`,
      args,
      options
    );
  }

  async function update<T extends Prisma.AccountUpdateArgs>(
    ...
    try {
      ...
      >(`${endpoint}/account/update`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function updateMany<T extends Prisma.AccountUpdateManyArgs>(
    args: Prisma.SelectSubset<T, Prisma.AccountUpdateManyArgs>
  ) {
    return await request.put<
      Prisma.SelectSubset<T, Prisma.AccountUpdateManyArgs>,
      Prisma.BatchPayload
    >(`${endpoint}/account/updateMany`, args, mutate);
  }

  async function upsert<T extends Prisma.AccountUpsertArgs>(
    ...
    try {
      return await request.post<
        ...
        Prisma.AccountGetPayload<T>
      >(`${endpoint}/account/upsert`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function del<T extends Prisma.AccountDeleteArgs>(
    args: Prisma.SelectSubset<T, Prisma.AccountDeleteArgs>
  ) {
    try {
      return await request.del<Prisma.AccountGetPayload<T>>(
  ...
  async function deleteMany<T extends Prisma.AccountDeleteManyArgs>(
  ...
  function aggregate<T extends Prisma.AccountAggregateArgs>(
    args: Prisma.Subset<T, Prisma.AccountAggregateArgs>,
    options?: RequestOptions<Prisma.GetAccountAggregateType<T>>
  ) {
    return request.get<Prisma.GetAccountAggregateType<T>>(
      `${endpoint}/account/aggregate`,
      args,
      options
    );
  ...
  >(
    args: Prisma.SubsetIntersection<T, Prisma.AccountGroupByArgs, OrderByArg> &
      InputErrors,
  ...
  function count<T extends Prisma.AccountCountArgs>(
      ...
      T extends { select: any }
        ? T['select'] extends true
          ...
          : Prisma.GetScalarType<
              T['select'],
              Prisma.AccountCountAggregateOutputType
            >
        : number
    >
  ) {
