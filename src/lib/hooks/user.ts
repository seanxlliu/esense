...
export function useUser() {
  ...
  async function create<T extends Prisma.UserCreateArgs>(
    ...
    try {
      ...
      >(`${endpoint}/user/create`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  function findMany<T extends Prisma.UserFindManyArgs>(
    ...
    return request.get<Array<Prisma.UserGetPayload<T>>>(
  ...
  function findUnique<T extends Prisma.UserFindUniqueArgs>(
    ...
    return request.get<Prisma.UserGetPayload<T>>(
  ...
  function findFirst<T extends Prisma.UserFindFirstArgs>(
  ...
  async function update<T extends Prisma.UserUpdateArgs>(
    ...
    try {
      ...
      >(`${endpoint}/user/update`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function updateMany<T extends Prisma.UserUpdateManyArgs>(
    ...
    return await request.put<
      ...
      Prisma.BatchPayload
    >(`${endpoint}/user/updateMany`, args, mutate);
  }

  async function upsert<T extends Prisma.UserUpsertArgs>(
    ...
    try {
      return await request.post<
        ...
        Prisma.UserGetPayload<T>
      >(`${endpoint}/user/upsert`, args, mutate);
    } catch (err: any) {
      if (
        err.info?.prisma &&
        err.info?.code === 'P2004' &&
  ...
  async function del<T extends Prisma.UserDeleteArgs>(
    ...
    try {
      return await request.del<Prisma.UserGetPayload<T>>(
  ...
  function aggregate<T extends Prisma.UserAggregateArgs>(
    args: Prisma.Subset<T, Prisma.UserAggregateArgs>,
    options?: RequestOptions<Prisma.GetUserAggregateType<T>>
  ) {
    return request.get<Prisma.GetUserAggregateType<T>>(
      `${endpoint}/user/aggregate`,
      args,
      options
    );
  ...
  function count<T extends Prisma.UserCountArgs>(
